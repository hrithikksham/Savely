import type { Transaction, CategoryBreakdown, MonthlyData, BalanceTrendPoint, InsightsSummary } from '../types';
...
export function computeMonthlyComparison(transactions: Transaction[]): MonthlyData[] {
  const now = new Date();
